...
const PRODUCTS = [
  {
    ...
    category: "frames",
    price: 3500,
    desc: "Handcrafted mahogany frame. Available A4–A1.",
  ...
  },
  {
    ...
    category: "frames",
    price: 6500,
    desc: "Museum-quality acrylic mount. Crystal-clear finish.",
    img: "https://images.unsplash.com/photo-1711014476536-0edbcadb9d71?w=400",
  },
  {
    id: 3,
    ...
    category: "frames",
    price: 2800,
    desc: "Slim brushed aluminium. Suits modern interiors.",
    img: "https://images.unsplash.com/photo-1584824486509-112e4181ff6b?w=400",
  },
  {
    id: 4,
    ...
    category: "prints",
    price: 2200,
    desc: "Gallery-wrapped canvas, ready to hang. A3 size.",
    img: "https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=400",
  },
  {
    id: 5,
    name: "Lustre Print – A4",
    category: "prints",
    price: 850,
    desc: "Professional lustre finish, vibrant colours.",
    img: "https://images.unsplash.com/photo-1533158326339-7f3cf2404354?w=400",
  },
  {
    id: 6,
    name: "Fine Art Print – A2",
    category: "prints",
    price: 4500,
    desc: "Archival pigment print on 310gsm cotton rag.",
    img: "https://images.unsplash.com/photo-1510936111840-65e151ad71bb?w=400",
  },
  {
    id: 7,
    ...
    category: "albums",
    price: 8500,
    desc: "20 spreads, flush-mount binding. 10×10 inches.",
    img: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400",
  },
  {
    id: 8,
    name: "Wedding Album – Linen",
    category: "albums",
    price: 14500,
    desc: "Linen-covered hardback, 30 spreads, personalised.",
    img: "https://images.unsplash.com/photo-1519741497674-611481863552?w=400",
  },
  {
    id: 9,
    name: "Mini Boudoir Album",
    category: "albums",
    price: 4200,
    desc: "Compact 6×6 inch softcover. 15 pages.",
    img: "https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?w=400",
  },
  {
    id: 10,
    name: "USB Drive – Engraved",
    category: "accessories",
    price: 1800,
    desc: "Branded wooden USB with engraved logo. 32 GB.",
    img: "https://images.unsplash.com/photo-1618044733300-9472054094ee?w=400",
  },
  {
    id: 11,
    name: "Gift Voucher – KSh 5K",
    category: "accessories",
    price: 5000,
    desc: "Redeemable against any session or product.",
  ...
  },
  {
    ...
    category: "accessories",
    price: 650,
    desc: "Acrylic keyring with your chosen photo.",
...
function saveCart() {
  localStorage.setItem("joyalty_cart", JSON.stringify(cart));
}
...
function renderCartItems() {
  ...
  if (!cart.length) {
    container.innerHTML =
      '<div class="cart-empty"><i class="fa-solid fa-cart-shopping" style="font-size:2rem;opacity:.25;display:block;margin-bottom:10px"></i>Your cart is empty</div>';
    return;
  }
...
function openCheckout() {
  ...
  const lines = cart
    .map(
      (i) => `${i.name} ×${i.qty} — KSh ${(i.price * i.qty).toLocaleString()}`,
    )
    .join("<br>");
  const total = cart.reduce((a, i) => a + i.price * i.qty, 0);
...
async function placeOrder() {
  ...
  btn.disabled = true;
  btn.innerHTML =
    '<i class="fa-solid fa-circle-notch fa-spin me-2"></i>Processing…';
  ...
  try {
    ...
    btn.disabled = false;
    btn.innerHTML =
      '<i class="fa-solid fa-check me-2"></i>Place Order — Pay via M-Pesa';
  }
}
...
if (fb)
  new IntersectionObserver(
    (e) => {
      if (e[0].isIntersecting) fb.classList.add("footer-visible");
    },
    { threshold: 0.1 },
  ).observe(fb);
